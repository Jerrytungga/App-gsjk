    ...
    <div>
      ...
      <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
        <ul id="sidebarnav">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('halaman-Ft-lokal')}}" aria-expanded="false">
              <span>
                <i class="ti ti-users"></i>
              </span>
              <span class="hide-menu">FT Lokal</span>
            </a>
          </li>

          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('halaman-kaum-saleh')}}" aria-expanded="false">
              <span>
                <i class="ti ti-users"></i>
              </span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('halaman-Kontakan')}}" aria-expanded="false">
              <span>
                <i class="ti ti-users"></i>
              </span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('halaman-sekolah')}}" aria-expanded="false">
              <span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('halaman-universitas')}}" aria-expanded="false">
              <span>
                <i class="ti ti-school"></i>
              </span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('bailai-sidang')}}" aria-expanded="false">
              <span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('halaman-baptisan')}}" aria-expanded="false">
              <span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('jadwal.index')}}" aria-expanded="false">
              ...
              <span class="hide-menu">Jadwal Sidang</span>
            </a>
          </li>
          <li class="nav-small-cap">
            <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('halaman-rumah-belajar')}}" aria-expanded="false">
              <span>
                <i class="ti ti-users"></i>
              </span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('file-manager.index')}}" aria-expanded="false">
              <span>
